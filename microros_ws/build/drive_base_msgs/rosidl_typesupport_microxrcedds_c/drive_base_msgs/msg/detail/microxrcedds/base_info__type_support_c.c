  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: overcurrent
  rv = ucdr_serialize_bool(cdr, (ros_message->overcurrent) ? 0x01 : 0x00);
  // Member: blocked
  rv = ucdr_serialize_bool(cdr, (ros_message->blocked) ? 0x01 : 0x00);
  // Member: in_collision
  rv = ucdr_serialize_bool(cdr, (ros_message->in_collision) ? 0x01 : 0x00);
  // Member: at_cliff
  rv = ucdr_serialize_bool(cdr, (ros_message->at_cliff) ? 0x01 : 0x00);
  // Member: safety_state
